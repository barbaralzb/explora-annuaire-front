...
export default function Hero () {
  ...
  return (
    <div className='min-h-screen h-full w-full max-h-screen bg-dots pt-20 lg:pt-32 xl:pt-40 '>
              ...
              <main>
                <div className='sm:text-center lg:text-left'>
                  <h1 className='tracking-tight font-extrabold text-gray-900 '>
                    ...
                    <div className='block text-deep-purple-600 text-2xl sm:text-3xl md:text-4xl'>Annuaire des evenement associatif</div>
                  </h1>
